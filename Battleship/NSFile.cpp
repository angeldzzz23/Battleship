...
void NSFile::readingame(User* user1, User* user2){//loading in a game
    ...
    for(int i = 0; i < 2; i++){
        cout <<"Destroyer: " <<endl;
       cout <<"Before adding index " <<i <<": " <<gameloader.player1.destroy.position[i].row <<endl;
       cout <<"Col: " <<gameloader.player1.destroy.position[i].col <<endl;
       Coordinate *tester = new Coordinate(gameloader.player1.destroy.position[i].row, gameloader.player1.destroy.position[i].col);
       cout <<"Tester index " <<i <<": " <<tester->getRow() <<endl;
       cout <<"Col: " <<tester->getCol() <<endl;
       transferdes[i] = tester;
       cout <<"After adding index " <<i <<": " <<transferdes[i]->getRow() <<endl;
       cout <<"Col: " <<transferdes[i]->getCol() <<endl;
       delete tester;
    }
    Destroyer *transdes1 = new Destroyer();
    cout <<"Adding in boat 1: ";
    transdes1->addCords(transferdes, 2);
    user1->adBoat(transdes1);
    //cruiser
    for(int i = 0; i < 3; i++){
       cout <<"Cruiser: " <<endl;
       cout <<"Before adding index " <<i <<": " <<gameloader.player1.cruisee.position[i].row <<endl;
       cout <<"Col: " <<gameloader.player1.cruisee.position[i].col <<endl;
       Coordinate *tester = new Coordinate(gameloader.player1.cruisee.position[i].row, gameloader.player1.destroy.position[i].col);
       cout <<"Tester index " <<i <<": " <<tester->getRow() <<endl;
       cout <<"Col: " <<tester->getCol() <<endl;
       transfercruise[i] = tester;
       cout <<"After adding index " <<i <<": " <<transfercruise[i]->getRow() <<endl;
       cout <<"Col: " <<transfercruise[i]->getCol() <<endl;
       delete tester;
    }
    Cruiser *transcruise1 = new Cruiser();
    transcruise1->addCords(transfercruise,3);
    user1->adBoat(transcruise1);
    //submarine
    for(int i = 0; i < 3; i++){
       cout <<"Submarine: " <<endl;
       cout <<"Before adding index " <<i <<": " <<gameloader.player1.sub.position[i].row <<endl;
       cout <<"Col: " <<gameloader.player1.sub.position[i].col <<endl;
       Coordinate *tester = new Coordinate(gameloader.player1.sub.position[i].row, gameloader.player1.destroy.position[i].col);
       cout <<"Tester index " <<i <<": " <<tester->getRow() <<endl;
       cout <<"Col: " <<tester->getCol() <<endl;
       transfersub[i] = tester;
       cout <<"After adding index " <<i <<": " <<transfersub[i]->getRow() <<endl;
       cout <<"Col: " <<transfersub[i]->getCol() <<endl;
       delete tester;
    }
    Submarine *transub1 = new Submarine();
    transub1->addCords(transfersub,3);
    user1->adBoat(transub1);
    //battleship
    for(int i = 0; i < 4; i++){
       cout <<"Battleship: " <<endl;
       cout <<"Before adding index " <<i <<": " <<gameloader.player1.battle.position[i].row <<endl;
       cout <<"Col: " <<gameloader.player1.battle.position[i].col <<endl;
       ...
       cout <<"After adding index " <<i <<": " <<transferbattle[i]->getRow() <<endl;
       cout <<"Col: " <<transferbattle[i]->getCol() <<endl;
       delete tester;
    }
    Battleshp *transbat1 = new Battleshp();
    transbat1->addCords(transferbattle,4);
    user1->adBoat(transbat1);
    //carrier
    for(int i = 0; i < 5; i++){
       cout <<"Before adding index " <<i <<": " <<gameloader.player1.carr.position[i].row <<endl;
       cout <<"Col: " <<gameloader.player1.carr.position[i].col <<endl;
       ...
       cout <<"After adding index " <<i <<": " <<transfercarr[i]->getRow() <<endl;
       cout <<"Col: " <<transfercarr[i]->getCol() <<endl;
       delete tester;
    }
    Carrier *transcarr1 = new Carrier();
    transcarr1->addCords(transfercarr, 5);
    user1->adBoat(transcarr1);
    //user2
   for(int i = 0; i < 2; i++){
       cout <<"Before adding index " <<i <<": " <<gameloader.player2.destroy.position[i].row <<endl;
       cout <<"Col: " <<gameloader.player2.destroy.position[i].col <<endl;
