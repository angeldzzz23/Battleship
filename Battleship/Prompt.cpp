 ...
 * Version 2 - Ethan and Yanis - Added a menu option for saving and loading a game - all still need to be integrated with other classes
 */
...
void Prompt::getturn(){ //function for taking turns - all inputs c strings for input validation
    ...
    do{
        ...
        else if (*input == '4'){ //option to now quit and save game
...
void Prompt::mainmenu(){ //function for the main menu - all inputs c strings for input validation
    ...
    do{
        ...
        if(*input == '1'){
            ...
            cout <<"Loading saved game..." <<endl;  //loads saved game
            valid = true;
        }
        else if (*input == '4'){
